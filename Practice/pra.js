...
// var id = [10,20,30,40,50]
// for(var i=0; i<id.length; i++){
//     console.log(id[i], i)
// }

// var id=[10,20,30,40]
// for(var i=id.length-1; i>=0; i-=10){
//     console.log(id[i])
// }
...
// var numbers = [2, 4, 8, 15, 11, 3, 16];
// var evenArray = [];

// function findEven(numbers, evenArray) {
...
// const items = ["APPLE", "BANANA", "PINEAPPLE", "MANGO"];
// const copyItems = [];
...
//    {name: "Priya", age: 55, gender: "Female"}
// ];
...
// const removeDuplicateString = new Set(str).join('');
...
// let doubleNumbers = numbers.map((e)=>e*4);
// console.log(doubleNumbers);

// let num = numbers.map((e)=>e*5);
// console.log(num);
